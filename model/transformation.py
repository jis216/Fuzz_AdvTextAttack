...
class PhraseSwapMaskedLM(WordSwap):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._phrase_tokenizer = phrase_tokenizer
    ...
    def _encode_text(self, text):
        ...
        entry = self._phrase_tokenizer.tokenize(text)
        return encoding.to(utils.device), entry
            ...
            for j in range(len(ids)):
                ...
                for _id in ranked_indices:
                    ...
                    if utils.check_if_subword(
                        ...
                        # strip_BPE_artifacts: token.replace("##", "")
    ...
    def _phrase_attack_replacement_words(
        self,
        current_text,
        index,
        id_preds,
        ...
        encoded, entry = self._encode_text(masked_text.text)
    ...
    def _get_transformations(self, current_text, indices_to_modify):
        ...
        encoded, entry = self._encode_text(current_text.text)
